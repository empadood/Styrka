  ...
  sessions: [
    {
      ...
      name: "Session A",
      exercises: [
        { exerciseId: EXERCISE.squat, label: EXERCISE_LABELS.squat, sets: 3, reps: 5 },
        { exerciseId: EXERCISE.deadlift, label: EXERCISE_LABELS.deadlift, sets: 1, reps: 5 },
        { exerciseId: EXERCISE.ohp, label: EXERCISE_LABELS.ohp, sets: 3, reps: 5 },
      ],
    },
    {
      id: "B",
      ...
      exercises: [
        { exerciseId: EXERCISE.squat, label: EXERCISE_LABELS.squat, sets: 3, reps: 5 },
        { exerciseId: EXERCISE.deadlift, label: EXERCISE_LABELS.deadlift, sets: 1, reps: 5 },
        { exerciseId: EXERCISE.benchpress, label: EXERCISE_LABELS.benchpress, sets: 3, reps: 5 },
      ],
    },
  ],
};
